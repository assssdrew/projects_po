...
- Рядом со значком обновления — едва заметный (полупрозрачный, мелкий) номер
  версии `vX.X`. Не мешает внешнему виду, но позволяет на глаз, без захода в
  меню, свериться с `CORE_VERSION` в этом README и понять, дошёл ли новый код
