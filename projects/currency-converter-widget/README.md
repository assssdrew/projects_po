...
4. Сверь номер версии с тем, что в этом README (сейчас `6.0`) — если меньше,
...
- Плоский список `147 USD → 12 241,3 RUB`, под каждой строкой — изменение
  курса за сутки `▲0.4%  за 24ч` и рядом мини-график (зелёным — рост,
  красным — падение), если накопилась история
