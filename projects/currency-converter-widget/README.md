...
4. Сверь номер версии с тем, что в этом README (сейчас `5.0`) — если меньше,
...
- Слева тускло-серым — пара (`USD/RUB`), в центре крупно белым — только
  ...
  изменения; у первой пары на large-виджете справа вместо стрелки —
  мини-график (спарклайн) изменения курса за собранную историю
