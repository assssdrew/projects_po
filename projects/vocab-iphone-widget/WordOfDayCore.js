// WordOfDayCore — v34: меньше зазор между примерами, первый не обрезается
...
const PASSIVE_MARKER = "PASSIVE_WIDGET_V34";
...
function createWidget(progress) {
  ...
  if (progress.kind === "rule" && progress.rule) {
    ...
    if (family === "accessoryCircular") {
      ...
      // Три примера: EN + до 2 строк перевода; плотнее между блоками
