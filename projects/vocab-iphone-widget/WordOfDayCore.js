// WordOfDayCore — v35: перевод переносится только когда реально не влезает
...
const PASSIVE_MARKER = "PASSIVE_WIDGET_V35";
...
function addExampleBlock(w, word, opts) {
  ...
  w.addSpacer(accessory ? 1 : 2);
  // почти вся ширина контента; 2 pt — крошечный запас у правого края
  let lines = accessory
    ? [ruText]
    : wrapLines(ruText, ruSize, Math.max(40, maxW - 2), 2);
