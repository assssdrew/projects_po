// WordOfDayCore — v38: у правил отступ сверху/снизу 12 pt
...
const PASSIVE_MARKER = "PASSIVE_WIDGET_V38";
...
function createWidget(progress) {
  ...
  const padY = progress.kind === "rule" ? 12 : 16;
  const padX = 12;
  ...
  if (progress.kind === "rule" && progress.rule) {
    ...
    if (family === "accessoryCircular") {
      ...
      // края — padY 12; нижний flex не ставим, иначе схлопывает отступ снизу
      return w;
    }
  } else {
