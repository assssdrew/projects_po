// WordOfDayCore — v25: крупнее шрифт, больше зазор между парами
...
const PASSIVE_MARKER = "PASSIVE_WIDGET_V25";
...
function createWidget(progress) {
  ...
  if (accessory) {
    ...
    w.setPadding(4, 12, 4, 12);
  } else {
    // минимум сверху/снизу: свободная высота уходит между парами
    w.setPadding(0, 12, 0, 12);
  }
